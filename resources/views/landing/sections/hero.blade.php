    ...
    <div class="container-main relative py-20 lg:py-32">
        <div class="mx-auto max-w-4xl text-center">
            <h1 class="text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl">
                {{ $section->title ?? 'Điều Hòa Tủ Đứng' }}
            </h1>
            ...
            <div class="mt-8 flex flex-wrap items-center justify-center gap-6 text-sm text-primary-200">
                <span class="flex items-center gap-2">
                    ...
                    Đối chiếu theo dữ liệu sản phẩm
                </span>
                <span class="flex items-center gap-2">
            ...
            <div class="mt-12 border-t border-white/10 pt-8">
                <p class="mb-4 text-xs uppercase tracking-widest text-primary-300">Thương hiệu sản phẩm</p>
