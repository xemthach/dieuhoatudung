...
return new class extends Migration
{
    ...
    {
        if (! Schema::hasTable('ai_bulk_runtime_batches')) {
        ...
        if (! Schema::hasTable('ai_bulk_runtime_slots')) {
        ...
        if (! Schema::hasTable('ai_bulk_runtime_leases')) {
            Schema::create('ai_bulk_runtime_leases', function (Blueprint $table): void {
                ...
                // DATETIME avoids MariaDB's implicit TIMESTAMP defaults under
                // NO_ZERO_DATE while preserving the explicit lease timestamps.
        ...
        if (! Schema::hasTable('ai_bulk_field_operations')) {
        ...
        if (! Schema::hasTable('ai_bulk_apply_snapshots')) {
