...
final class AiContentStatusPresenter
{
    ...
    public function present(string|BackedEnum|null $status, ?array $worker = null, bool $applied = false): array
    {
        ...
        $view = match ($key) {
            ...
            'REJECTED' => ['Đã từ chối', 'gray', false, true, false],
            'DISCARDED' => ['Đã loại bỏ', 'gray', false, true, false],
            'GENERATED' => ['Đã tạo', 'success', false, true, false],
            'EMPTY' => ['Trống', 'warning', false, true, false],
            'PARSE_FAILED' => ['Lỗi đọc phản hồi', 'danger', false, true, false],
            'VALIDATION_FAILED' => ['Không đạt kiểm tra', 'danger', false, true, false],
            'NOT_REQUESTED' => ['Không yêu cầu', 'gray', false, true, false],
    ...
    public function normalize(?string $status): string
    {
        return match (strtolower(trim((string) $status))) {
            ...
            'rejected' => 'REJECTED',
            'discarded' => 'DISCARDED',
            'generated', 'passed', 'valid' => 'GENERATED',
            'empty' => 'EMPTY',
            'parse_failed' => 'PARSE_FAILED',
            'validation_failed' => 'VALIDATION_FAILED',
            'not_requested', 'skipped' => 'NOT_REQUESTED',
            'warning', 'validation_warning' => 'COMPLETED_WITH_ERRORS',
